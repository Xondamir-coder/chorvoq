<template>
	<GenplanWrapper :background-image="`/images/blocks/${params.phase_id}.avif`" :paths="blocks" />
</template>

<script setup>
import blocksData1 from '~/assets/data/blocks/1.json';

const { t } = useI18n();
const { params } = useRoute();

const blocks = params.phase_id == 1 ? blocksData1 : [];
